...
<br/>
	...
	<tr>
		<td style="width: 400px; font-family:'微软雅黑';"><a href="doPublicDownloadMaterial?materialName=${mi.materialName}&materialURL=${mi.materialURL}">[${mi.materialName }]</a></td><td style="width: 100px; font-family:'微软雅黑'; ">可下载</td>
