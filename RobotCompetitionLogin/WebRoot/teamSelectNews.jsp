...
<br/>
	...
	<tr>
		<td style="width: 400px; font-family:'微软雅黑';"><a href="doTeamSelectOneNews?newsId=${news.newsId}">[${news.newsName}]</a></td><td style="width: 100px; font-family:'微软雅黑'; ">${news.datetime }</td>
