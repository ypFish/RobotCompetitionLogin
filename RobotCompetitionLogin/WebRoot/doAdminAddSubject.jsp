...
<br/>
	...
	if(request.getParameter("subjectName")!=null&&!("".equals(request.getParameter("subjectName")))){
		request.setCharacterEncoding("utf-8");
		String subjectName=request.getParameter("subjectName");
		int peopleNumber=Integer.parseInt(request.getParameter("peopleNumber"));
		String subjectInformation=request.getParameter("subjectInformation");
		String remark="";
		SubjectInfo si=new SubjectInfo(subjectName,peopleNumber,subjectInformation,remark);
		SubjectInfoBiz sib=new SubjectInfoBizImpl();
		int num=0;
		num=sib.addAll(si);
		if(num>0){
			out.print("<h3>科目信息添加成功！<h3>");
		}else{
			out.print("<h3>科目信息添加失败！(您添加的数据已经录入，不能重复添加或者录入信息有误。)<h3>");
		}
	}
	 %>
	 <br/>
	 ...
	 <a href="adminAddSubject.jsp" >[继续添加]</a>
	 &nbsp;&nbsp;&nbsp;
	 <a href="adminSelectSubject.jsp" >[查看数据]</a>
