...
<br/>
	...
	<tr >
		<td style="width: 400px; font-family:'微软雅黑'; height: 40px;">&nbsp;&nbsp;&nbsp;&nbsp;通知标题</td> <td style="width: 100px; height: 40px; font-family:'微软雅黑'; ">发布时间</td>
	</tr>
		<c:forEach var="news" items="${listNews}" >
	<tr>
		<td style="width: 400px; font-family:'微软雅黑';"><a href="doPublicSelectOneNews?newsId=${news.newsId}">[${news.newsName}]</a></td><td style="width: 100px; font-family:'微软雅黑'; ">${news.datetime }</td>
